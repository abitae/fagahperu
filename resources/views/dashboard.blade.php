    ...
    <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-2 ">
        ...
        <div
            ...
            <div data-popover="" id="popover-description" role="tooltip"
                ...
                style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(-299px, 81px);">
            ...
            <div
                ...
                <div>
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(883px, 701px);">
